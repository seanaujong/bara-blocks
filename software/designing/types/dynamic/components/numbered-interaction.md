...
A [relationship](../../../components/relationship.md) labeled with a sequence number instead of
(or alongside) a technology tag, showing where it falls in one scenario's order of events.
Elements stay in a free-form layout — unlike a UML sequence diagram, there's no lifeline forcing a
