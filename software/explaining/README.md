...
- **[Product Walkthrough](./types/product-walkthrough/README.md)** — how a customer uses a
  product or feature, in their own terms.
- **[Developer Guide](./types/developer-guide/README.md)** — how a developer uses a tool, API, or
  library.
- **[PR Description](./types/pr-description/README.md)** — what a code change does, why, and how
  you know it works.
- **[Design Doc](./types/design-doc/README.md)** — what should be built, which options were
  weighed, and why one was chosen.
- **[Architecture Overview](./types/architecture-overview/README.md)** — the author's intended
  shape for a project, kept current: its layers, their contracts, and how to extend them.
