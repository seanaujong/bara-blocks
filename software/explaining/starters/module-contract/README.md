...
**For this starter:** one canonical call, showing the calling convention the Interface section only
described in the abstract.

### [Interface](../../blocks/body/interface.md)

**For this starter:** the intended public surface, declared up front — signatures and types, not a
usage sample.
