...
- Explaining what the system does internally instead of what the customer sees and does.
- Steps out of the order the customer would actually perform them.
- A before/after pair where the "after" screenshot doesn't actually look different.
